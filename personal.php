...
$sql = "INSERT INTO personal_info( birth_id,name, gender) VALUES('$bid', '$name','$gender' )";
// $dept, $subject, $contact, $email
if ($conn->query($sql) === TRUE) {
    echo "Your Information Saved successfully";
} else {
    if ($birth_id == "" || $name == "" || $gender= "" ) {
...
<form action=""method="post">
  <fieldset>
    <h1 style="text-align:center;background-color:#719a71; width: 100%;">Personal Information</h1><br>
    <h4>Birth Id<br>
    <input type="text" name="bid"placeholder="Enter Birth Id" value="" required><br><br>
    Name<br>
    <input type="text" name="name"placeholder="Enter Name" value=""><br><br>
    Gender<br>
    <input type="text" name="gender"placeholder="Enter Gender" value=""required><br><br>
